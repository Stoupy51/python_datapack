...
DEPS_TO_UPDATE: str = f"{ROOT}/src/python_datapack/dependencies/bookshelf.py"
...
def download_latest_release() -> None:
	...
	file_content: str = f"""
# This file is auto-generated by the release script ({__file__})
BOOKSHELF_MODULES = {dumped}
"""

	with open(DEPS_TO_UPDATE, "w") as f:
