...
@stp.deprecated("This function has been renamed to write_file(), please update your code")
def write_to_file(*args, **kwargs):
	return write_file(*args, **kwargs)

@stp.deprecated("This function has been renamed to write_function(), please update your code")
def write_to_function(*args, **kwargs):
	return write_function(*args, **kwargs)

@stp.deprecated("This function has been renamed to write_advancement(), please update your code")
